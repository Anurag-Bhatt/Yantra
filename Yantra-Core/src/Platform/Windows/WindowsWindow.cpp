...
void WindowsWindow::Init(const WindowProps &prop) {
  ...
  YANTRA_CORE_INFO("Creating window {0} ({1}) ({2})", prop.Title, prop.width,
                   prop.height);
  ...
  m_Window = glfwCreateWindow((int32)prop.width, (int32)prop.height,
                              prop.Title.c_str(), nullptr, nullptr);
