...
// Core log macros
#define YANTRA_CORE_TRACE(...)                                                 \
  ::Yantra::Log::GetCoreLogger()->trace(__VA_ARGS__)
...
#define YANTRA_CORE_ERROR(...)                                                 \
  ::Yantra::Log::GetCoreLogger()->error(__VA_ARGS__)
#define YANTRA_CORE_CRITICAL(...)                                              \
  ::Yantra::Log::GetCoreLogger()->critical(__VA_ARGS__)
...
#define YANTRA_CRITICAL(...)                                                   \
  ::Yantra::Log::GetClientLogger()->critical(__VA_ARGS__)
