...
public:
  ...
  void OnUpdate() override {
    ...
    if (Yantra::Input::IsKeyPressed(Yantra::KeyCode::Space)) {
      YANTRA_INFO("Spacebar Pressed!!");
    }

    if (Yantra::Input::IsMouseButtonPressed(Yantra::MouseCode::Button0)) {
      YANTRA_INFO("Mouse button0 pressed");
    }
  }
